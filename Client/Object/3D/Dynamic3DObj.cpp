...
void Dynamic3DObj::Init(const std::string& key)
{
    ...
    else if (m_key.find("carrotL") != std::string::npos)
    {
        ...
        m_transform.SetLocation(glm::vec3(3.91f - 0.3f * flagCarrotL, 0.8f, 3.81f));
    ...
    {
        m_transform.SetRotation(glm::vec3(0.0f, 0.0f, 0.0f));
        m_transform.SetLocation(glm::vec3(3.91f - 0.3f * flagCarrotR, 0.8f, 4.31f));
    ...
    {
        m_transform.SetRotation(glm::vec3(0.0f, 0.0f, 0.0f));
        m_transform.SetLocation(glm::vec3(1.55f, 0.8f, -0.63f));
        m_transform.SetScale(0.18f);
    }
    else if (m_key.find("pumpkin2") != std::string::npos)
    {
        m_transform.SetRotation(glm::vec3(0.0f, 0.0f, 0.0f));
        m_transform.SetLocation(glm::vec3(-0.120f, 0.8f, -1.800f));
