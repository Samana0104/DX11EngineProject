...
void Dynamic3DObj::Init(const std::string& key)
{
    ...
    else if (m_key.find("carrotL") != std::string::npos)
    {
        ...
        //                              "~carrotL" + std::to_string(flagCarrotL) + ".hbs");
        // }
    ...
    else if (m_key.find("carrotR") != std::string::npos)
    {
        ...
        if (flagCarrotR == 0)
        {
            // aabbCol.min.x = 2.93f * 10 / 3;
            // aabbCol.min.y = 0.73f * 10 / 3;
            // aabbCol.min.z = 4.23f * 10 / 3;
            // aabbCol.max.x = 3.11f * 10 / 3;
            // aabbCol.max.y = 1.18f * 10 / 3;
            // aabbCol.max.z = 4.4f * 10 / 3;
